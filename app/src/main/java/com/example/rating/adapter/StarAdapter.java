package com.example.rating.adapter;
...
public class StarAdapter extends RecyclerView.Adapter<StarAdapter.StarViewHolder>implements Filterable{
    ...
    @NonNull
    @Override
    public StarAdapter.StarViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View v = LayoutInflater.from(this.cxt).inflate(R.layout.star_item, parent, false);
        final StarViewHolder holder = new StarViewHolder(v);
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                View popup = LayoutInflater.from(cxt).inflate(R.layout.star_edit_item, null, false);
                ...
                AlertDialog dialog = new AlertDialog.Builder(cxt)
                        ...
                        .setView(popup) .setPositiveButton("Valider", new DialogInterface.OnClickListener() {
                            @Override public void onClick(
                                ...
                                star.setStar(s); StarService.getInstance().update(star);
                                notifyItemChanged(holder.getAdapterPosition());
                            }
                        })
                        .setNegativeButton("Annuler", null) .create(); dialog.show(); } }); return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull StarAdapter.StarViewHolder holder, int i) {
        ...
        Glide.with(cxt)
                ...
                .into(holder.img);
        holder.name.setText(starsFilter.get(i).getName().toUpperCase());
        holder.stars.setRating(starsFilter.get(i).getStar());
        holder.idss.setText(starsFilter.get(i).getId()+"");
    }
    ...
    public class NewFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence charSequence) {
            ...
            { final String filterPattern = charSequence.toString().toLowerCase().trim();
                for (Star p : stars) {
                    if (p.getName().toLowerCase().startsWith(filterPattern)) { starsFilter.add(p);
